...
public class Versione implements Serializable {
  ...
  /** Nome Applicativo */
  public static final String NOME_APPL = "GPSInfo";

  /** Nome Applicativo */
  public static final String DESC_APPL = "Gestione dati GPS per foto";
  ...
  public static final String CSZ_DATEDEPLOY = "18/07/2024 17:13:09";

...
public class OpenCVFaceDetection {
  ...
  public void run(String[] args) {
    final String OpenCV = "F:/java/photon2/opencv";
    String filenameFaceCascade = args.length > 2 ? args[0] : OpenCV + "/data/haarcascades/haarcascade_frontalface_alt.xml";
    String filenameEyesCascade = args.length > 2 ? args[1] : OpenCV + "/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml";
